const HeaderContent = ({detailSurat}) => {
    return (
      <header className="w-full p-4 border fixed lg:w-[64.5%] h-30 top-10 left-0 lg:top-5 lg:left-223 lg:-translate-x-1/2  rounded-4xl bg-linear-65 from-purple-500 to-pink-500 text-white mirza"> 
